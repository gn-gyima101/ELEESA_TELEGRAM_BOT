...
course_links = {
    "L100": {
        "Semester 1": {
            "Engineering math 1": "https://drive.google.com/your_link_here",
            "Fundamentals of Engineering": "https://drive.google.com/your_link_here",
            "FRENCH": "https://drive.google.com/your_link_here",
            "Computer Literacy": "https://drive.google.com/your_link_here",
            "AutoCad": "https://drive.google.com/your_link_here",
            "Enviromental studies": "https://drive.google.com/your_link_here",
            "Academic Writing": "https://drive.google.com/your_link_here",
            "Eng. Lab 1": "https://drive.google.com/your_link_here",
        
        },
        "Semester 2": {
            "Academic writing": "https://drive.google.com/your_link_here",
            "C++ Programming": "https://drive.google.com/your_link_here",
            "Eng. Maths 2": "https://drive.google.com/your_link_here",
            "French": "https://drive.google.com/your_link_here",
            "African Studies": "https://drive.google.com/your_link_here",
            "Basic Mechanics": "https://drive.google.com/your_link_here",
            "Basic Electronics": "https://drive.google.com/your_link_here",
            "Engineering Drawing": "https://drive.google.com/your_link_here"
        }
    },
    "L200": {
        "Semester 1": {
        ...
        "Semester 2": {
            ...
            "Differential Eqn": "https://drive.google.com/your_link_here",
            "French": "https://drive.google.com/your_link_here",
            "Academic Writing": "https://drive.google.com/your_link_here",
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if text == "Back":
        if "semester" in session:
            ...
            level = session["level"]
            keyboard = [["Semester 1", "Semester 2"], ["Back"]]
            reply_markup = ReplyKeyboardMarkup(keyboard, resize_keyboard=True)
            await update.message.reply_text(f"You are back at {level}.\nNow choose a semester again:", reply_markup=reply_markup)
            return
        elif "level" in session:
            session.pop("level", None)
            keyboard = [["L100", "L200"], ["L300", "L400"]]
            reply_markup = ReplyKeyboardMarkup(keyboard, resize_keyboard=True)
            await update.message.reply_text("Back to main menu. Please select your level:", reply_markup=reply_markup)
            return

    if text == "Request":
        session["awaiting_request"] = True
        await update.message.reply_text("Please type your request below (e.g., missing course material).")
        return
    elif session.get("awaiting_request"):
        session.pop("awaiting_request")
        await update.message.reply_text("Thanks! Your request has been sent.")
        await context.bot.send_message(chat_id=5783729716, text=f"New request from {update.message.from_user.full_name} (ID: {user_id}):\n\n{text}")
        return
    ...
    if text in ["Semester 1", "Semester 2"] and "level" in session:
        ...
        keyboard = [[course] for course in courses] + [["Request", "Back"]]
        reply_markup = ReplyKeyboardMarkup(keyboard, resize_keyboard=True)
